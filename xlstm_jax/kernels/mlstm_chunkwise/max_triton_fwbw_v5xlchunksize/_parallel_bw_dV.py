...
from mlstm_kernels.mlstm_kernels.mlstm.chunkwise.max_triton_fwbw_v5xlchunksize._triton_parallel_bw_dV import (
    _mlstm_chunkwise_parallel_bw_dV_kernel,
)
...
def mlstm_chunkwise__parallel_bw_dV(
    ...
    Args:
        ...
        qk_scale: Scaling factor for the QK matrix. Defaults to None.
    ...
    matDeltaV = jt.triton_call(
        ...
        num_warps=num_warps,
        grid=grid,
        kernel=_mlstm_chunkwise_parallel_bw_dV_kernel,
    )
