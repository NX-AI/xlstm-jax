...
from mlstm_kernels.mlstm_kernels.mlstm.chunkwise.max_triton_fwbw_v5xlchunksize._triton_recurrent_fw import (
...
def mlstm_chunkwise__recurrent_fw_C(
    ...
    Args:
        ...
        vecF: Tensor containing the forget gate. Shape (B, NH, NC, L).
