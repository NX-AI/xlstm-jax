...
.. py:module:: xlstm_jax.kernels.mlstm_chunkwise.max_triton_fwbw_v5xlchunksize.triton_fwbw
...
.. autoapisummary::
   ...
   xlstm_jax.kernels.mlstm_chunkwise.max_triton_fwbw_v5xlchunksize.triton_fwbw._mlstm_chunkwise_fwbw_generator
   xlstm_jax.kernels.mlstm_chunkwise.max_triton_fwbw_v5xlchunksize.triton_fwbw._get_chunkwise_fwbw_kernel
   xlstm_jax.kernels.mlstm_chunkwise.max_triton_fwbw_v5xlchunksize.triton_fwbw.mlstm_chunkwise_max_triton


Module Contents
---------------

.. py:function:: _mlstm_chunkwise_fwbw_generator(autocast_kernel_dtype = jnp.bfloat16, return_last_states = False, recompute_states_in_bw = True, chunk_size = 64, eps = 1e-06)
...
.. py:function:: mlstm_chunkwise_max_triton(q, k, v, i, f, c_initial = None, n_initial = None, m_initial = None, return_last_states = False, eps = 1e-06, chunk_size = 64, autocast_kernel_dtype = jnp.float32)
